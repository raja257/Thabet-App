      ...
      <div className="w-full">
        <div className="flex gap-5">
          <Image
            ...
            height={30}
          />
          <p className="text-[#5C7069] text-[12px] font-medium max-w-[140px]">
            Access your child’s progress and updates.
          </p>
        </div>
              ...
              <form onSubmit={formik.handleSubmit}>
                <div className="w-full">
                  ...
                  <input
                    ...
                    type="email"
                    placeholder="Email"
                    className="xl:w-[80%] w-[100%] h-[48px] rounded-[8px] border-[1px] border-[#CAD0D9] 2xl:mt-[24px] text-[16px] font-medium text-[#000000] pl-3 outline-none"
                  ...
                  <div className="w-full mt-2">
                    ...
                    <div className="w-[100%] border-[1px] border-[#CAD0D9] h-[48px] relative rounded-[8px]">
                      <input
                        ...
                        className="w-[90%] h-[46px] rounded-[8px] text-[16px] font-medium pl-3 outline-none"
                        onChange={formik.handleChange}
                        onBlur={formik.handleBlur}
                  ...
                  <div className="xl:w-[80%] w-[100%] 2xl:mt-[24px] mt-[16px] flex justify-between items-center">
                    <div className="flex items-center gap-2">
                      <input type="checkbox" />
                      <p className="text-[12px] text-[#5C7069] font-normal">
                        Remember me
                      </p>
                    </div>
